...
<div class="purpose-statement">L'épanouissement de la vie consciente en réduisant les risques de l'IA.</div>

<p class="mission-statement">Nous faisons progresser la sûreté de l'IA par la collaboration, la recherche et l'éducation.</p>
...
<div class="card">
  <div class="card-header">
    <h3>Coordination vers un traité international sur la sûreté de l'IA</h3>
    <span class="card-meta">Depuis 2025</span>
  </div>
  <p>Appels mensuels de coordination qui rassemblent des acteurs canadiens de la société civile, des institutions de recherche, des organismes de normalisation et de l'industrie pour faire progresser les politiques et initiatives coordonnées en sûreté de l'IA.</p>
...
<details>
  ...
  <blockquote>« Très utile pour rencontrer et discuter avec les chercheurs en sûreté de l'IA à NeurIPS. » — <strong>Esben Kran</strong></blockquote>
  <blockquote>« Une excellente façon de rencontrer les meilleures personnes du domaine et propulser des idées audacieuses. » — <strong>Stuart Armstrong</strong></blockquote>
  <blockquote>« Les petits groupes de discussion m'ont exposé à de nouvelles perspectives. » — <strong>Adam Gleave</strong></blockquote>
</details>
